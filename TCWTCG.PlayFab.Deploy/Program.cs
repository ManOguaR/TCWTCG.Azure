...
using System.IO;
using System.Net;
using Server = PlayFab.ServerModels;
...
namespace TCWTCG.Azure.PlayFab
{
    public static class Program
    {
        ...
        //private const string currencyPath = "./legacy/Currency.json";
        //private const string titleSettingsPath = "./legacy/TitleSettings.json";
        //private const string titleDataPath = "./legacy/TitleData.json";
        //private const string catalogPath = "./legacy/Catalog.json";
        //private const string catalogPathEvents = "./legacy/CatalogEvents.json";
        //private const string dropTablesPath = "./legacy/DropTables.json";
        //private const string cloudScriptPath = "./legacy/CloudScript.js";
        //private const string titleNewsPath = "./legacy/TitleNews.json";
        //private const string statsDefPath = "./legacy/StatisticsDefinitions.json";
        //private const string storesPath = "./legacy/Stores.json";
        //private const string storesPathEvents = "./legacy/StoresEvents.json";
        //private const string cdnAssetsPath = "./legacy/CdnData.json";
        //private const string permissionPath = "./legacy/Permissions.json";
        ...
        //};
        //public static string cdnPath = "./legacy/AssetBundles/";
        ...
        private static bool UploadTitleNews()
        {
            ...
            var titleNewsItems = JsonWrapper.DeserializeObject<List<Server.TitleNewsItem>>(parsedFile);
        ...
        private static bool UploadPolicy(string filePath)
        {
            ...
            var permissionList = JsonWrapper.DeserializeObject<List<EntityPermissionStatement>>(parsedFile);
            var request = new SetGlobalPolicyRequest
            {
                Permissions = permissionList
            };

            var setPermissionTask = PlayFabProfilesAPI.SetGlobalPolicyAsync(request);
